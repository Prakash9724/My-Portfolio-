...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/prakashpatel',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/prakashpatel',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Twitter',
    url: 'https://twitter.com/prakashpatel',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/prakashpatel',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <motion.div
              className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#00f5a0] to-[#00d9f5] flex items-center justify-center"
              whileHover={{ rotate: 180 }}
              transition={{ duration: 0.3 }}
            >
              <span className="text-black font-bold text-2xl">PP</span>
            </motion.div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="mailto:hello@prakashpatel.com" className="hover:text-white transition-colors">
                  hello@prakashpatel.com
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} Prakash Patel. All rights reserved.
            </p>
